...
const navItems: NavItem[] = [
    ...
    path: "/areadashboard" } ,
  {
    ...
    //   { name: "Centre", path: "/centre", pro: false },
    //   { name: "Mandi", path: "/mandi", pro: false },
    //   { name: "StackHolders", path: "/stackholders", pro: false },
    //   { name: "User Role Access", path: "/usersrole", pro: false },
    //   { name: "Logistics", path: "/logistics", pro: false },
    //   { name: "Customer", path: "/customer", pro: false },
    //   { name: "Catogories", path: "/catogories", pro: false },
    //   { name: "Metirals", path: "/metirals", pro: false },
    //   { name: "Labours", path: "/labour", pro: false },
    //   { name: "Agent Commisson", path: "/agent-commission", pro: false },
    // ],
