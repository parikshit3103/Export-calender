...
const DashBoard:React.FC = () => {
  ...
  <div className="bg-white shadow-2xl rounded-2xl p-10 max-w-3xl w-full fade-up">
    <h1 className="text-3xl font-bold text-center text-[#184e93] mb-4">
      Welcome to <span className="text-blue-600">VMCCP</span>
    </h1>
    <p className="text-lg text-gray-700 text-center">
      <span className="text-xl font-bold">
      VikasNagar Municipal Committee Complaint </span> <span className="font-medium text-gray-900">Configurator</span> System
    </p>
